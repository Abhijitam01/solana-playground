        ...
        <div className="bg-[#111] border border-white/10 rounded-2xl p-8">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full py-3 rounded-lg border border-white/10 hover:bg-white/5 transition-colors flex items-center justify-center gap-3"
            >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 bg-white/5 border border-white/10 rounded-lg focus:outline-none focus:border-[#14F195] transition-colors text-white placeholder:text-white/30"
          ...
          <p className="text-center text-sm text-white/60 mt-6">
            ...
            <Link href="/signup" className="text-[#14F195] hover:underline font-medium">
              Sign up
            </Link>
          </p>
        </div>
