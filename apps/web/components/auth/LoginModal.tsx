              ...
              <div className="flex-1 p-8 md:p-12 relative z-10 flex flex-col">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-white/60">
                    {mode === 'login' 
                      ...
                      : 'Choose a social account to create your profile'}
                  </p>
                </div>
                ...
                <div className="flex-1 flex flex-col justify-center">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full py-3 rounded-lg border border-white/10 hover:bg-white/5 transition-colors flex items-center justify-center gap-2 disabled:opacity-60"
                  >
                  ...
                  <p className="text-center text-sm text-white/60 mt-6">
                    {loading ? 'Redirecting to provider...' : 'No email/password. OAuth only.'}
                  </p>
                </div>
              </div>
